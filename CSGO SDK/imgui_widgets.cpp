...
bool ImGui::Hotkey( const char* label, int* k, int defaultCondition ) {
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    RenderFrame( bb.Min, bb.Max, ImColor( 1.f, 1.f, 1.f, 0.1f * value->second ), 0, 1 );
