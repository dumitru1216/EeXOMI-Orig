...
bool ESteamPaymentRuleType_IsValid(int value);
const ESteamPaymentRuleType ESteamPaymentRuleType_MIN = k_EPaymentRuleTypeComposite;
const ESteamPaymentRuleType ESteamPaymentRuleType_MAX = k_EPaymentRuleTypeSpecialPayment;
const int ESteamPaymentRuleType_ARRAYSIZE = ESteamPaymentRuleType_MAX + 1;

const ::google::protobuf::EnumDescriptor* ESteamPaymentRuleType_descriptor();
inline const ::std::string& ESteamPaymentRuleType_Name(ESteamPaymentRuleType value) {
  return ::google::protobuf::internal::NameOfEnum(
    ESteamPaymentRuleType_descriptor(), value);
}
inline bool ESteamPaymentRuleType_Parse(
    const ::std::string& name, ESteamPaymentRuleType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ESteamPaymentRuleType>(
    ESteamPaymentRuleType_descriptor(), name, value);
}
// ===================================================================
...
class CMsgServerHello : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_legacy_steamdatagram_port() const;
  inline void clear_legacy_steamdatagram_port();
  static const int kLegacySteamdatagramPortFieldNumber = 5;
  inline ::google::protobuf::uint32 legacy_steamdatagram_port() const;
  inline void set_legacy_steamdatagram_port(::google::protobuf::uint32 value);

  // optional string steamdatagram_routing = 6;
  inline bool has_steamdatagram_routing() const;
  inline void clear_steamdatagram_routing();
  static const int kSteamdatagramRoutingFieldNumber = 6;
  inline const ::std::string& steamdatagram_routing() const;
  inline void set_steamdatagram_routing(const ::std::string& value);
  inline void set_steamdatagram_routing(const char* value);
  inline void set_steamdatagram_routing(const char* value, size_t size);
  inline ::std::string* mutable_steamdatagram_routing();
  inline ::std::string* release_steamdatagram_routing();
  inline void set_allocated_steamdatagram_routing(::std::string* steamdatagram_routing);
 ...
 private:
  ...
  inline void set_has_client_launcher();
  inline void clear_has_client_launcher();
  inline void set_has_legacy_steamdatagram_port();
  inline void clear_has_legacy_steamdatagram_port();
  inline void set_has_steamdatagram_routing();
  inline void clear_has_steamdatagram_routing();
  ...
  ::google::protobuf::uint32 client_launcher_;
  ::google::protobuf::uint32 legacy_steamdatagram_port_;
  ::std::string* steamdatagram_routing_;
...
// optional uint32 legacy_steamdatagram_port = 5;
inline bool CMsgServerHello::has_legacy_steamdatagram_port() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void CMsgServerHello::set_has_legacy_steamdatagram_port() {
  _has_bits_[0] |= 0x00000010u;
}
inline void CMsgServerHello::clear_has_legacy_steamdatagram_port() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void CMsgServerHello::clear_legacy_steamdatagram_port() {
  legacy_steamdatagram_port_ = 0u;
  clear_has_legacy_steamdatagram_port();
}
inline ::google::protobuf::uint32 CMsgServerHello::legacy_steamdatagram_port() const {
  return legacy_steamdatagram_port_;
}
inline void CMsgServerHello::set_legacy_steamdatagram_port(::google::protobuf::uint32 value) {
  set_has_legacy_steamdatagram_port();
  legacy_steamdatagram_port_ = value;
}

// optional string steamdatagram_routing = 6;
inline bool CMsgServerHello::has_steamdatagram_routing() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void CMsgServerHello::set_has_steamdatagram_routing() {
  _has_bits_[0] |= 0x00000020u;
}
inline void CMsgServerHello::clear_has_steamdatagram_routing() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void CMsgServerHello::clear_steamdatagram_routing() {
  if (steamdatagram_routing_ != &::google::protobuf::internal::kEmptyString) {
    steamdatagram_routing_->clear();
  }
  clear_has_steamdatagram_routing();
}
inline const ::std::string& CMsgServerHello::steamdatagram_routing() const {
  return *steamdatagram_routing_;
}
inline void CMsgServerHello::set_steamdatagram_routing(const ::std::string& value) {
  set_has_steamdatagram_routing();
  if (steamdatagram_routing_ == &::google::protobuf::internal::kEmptyString) {
    steamdatagram_routing_ = new ::std::string;
  }
  steamdatagram_routing_->assign(value);
}
inline void CMsgServerHello::set_steamdatagram_routing(const char* value) {
  set_has_steamdatagram_routing();
  if (steamdatagram_routing_ == &::google::protobuf::internal::kEmptyString) {
    steamdatagram_routing_ = new ::std::string;
  }
...
inline void CMsgServerHello::set_steamdatagram_routing(const char* value, size_t size) {
  set_has_steamdatagram_routing();
  if (steamdatagram_routing_ == &::google::protobuf::internal::kEmptyString) {
    steamdatagram_routing_ = new ::std::string;
  }
  steamdatagram_routing_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* CMsgServerHello::mutable_steamdatagram_routing() {
  set_has_steamdatagram_routing();
  if (steamdatagram_routing_ == &::google::protobuf::internal::kEmptyString) {
    steamdatagram_routing_ = new ::std::string;
  }
...
inline ::std::string* CMsgServerHello::release_steamdatagram_routing() {
  clear_has_steamdatagram_routing();
  if (steamdatagram_routing_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = steamdatagram_routing_;
    steamdatagram_routing_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void CMsgServerHello::set_allocated_steamdatagram_routing(::std::string* steamdatagram_routing) {
  if (steamdatagram_routing_ != &::google::protobuf::internal::kEmptyString) {
    delete steamdatagram_routing_;
  }
  if (steamdatagram_routing) {
    set_has_steamdatagram_routing();
    steamdatagram_routing_ = steamdatagram_routing;
  } else {
    clear_has_steamdatagram_routing();
    steamdatagram_routing_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ESteamPaymentRuleType>() {
  return ::ESteamPaymentRuleType_descriptor();
}
